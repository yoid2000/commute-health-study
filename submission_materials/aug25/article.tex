...
\sethlcolor{white}
% The following command designates the highlighting from May 25, but otherwise does nothing
\newcommand{\hlmay}[1]{#1}

\title{Comparison of Three Anonymization Tools for a Health Fitness Study}
