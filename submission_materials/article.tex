...
\subsection*{Reproduction of commute modes and distances}
...
%median distance from home to school (Table~3).
%
...
%35
\bibitem{kaabachi2025review}
\bibinfo{author}{Kaabachi, B.},
\bibinfo{author}{Despraz, J.}, 
\bibinfo{author}{Meurers, T.}, 
\bibinfo{author}{Otte, K.}, 
\bibinfo{author}{Halilovic, M.}, 
\bibinfo{author}{Kulynych, B.}, 
\bibinfo{author}{Prasser, F.}, 
\bibinfo{author}{Raisaro, J. L.}
\newblock \bibinfo{journal}{\bibinfo{title}{A scoping review of privacy and utility metrics in medical synthetic data}}.
\newblock {\emph{\JournalTitle{npj Digital Medicine}}} \textbf{\bibinfo{volume}{8}} (\bibinfo{year}{2025}).
...
Absolute error of the three anonymization methods for the counts and distances in Tables 1  and 2. Each box plot data point is taken from a single cell in Tables 2 and 3.
